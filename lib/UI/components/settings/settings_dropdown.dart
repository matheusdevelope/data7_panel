import 'package:data7_panel/UI/components/dropdown.dart';
import 'package:data7_panel/UI/components/icon_style.dart';
...
class SettingRowDropDown extends StatefulWidget {
  ...
  @override
  SettingRowDropDownState createState() => SettingRowDropDownState();
}

class SettingRowDropDownState extends State<SettingRowDropDown> {
  @override
